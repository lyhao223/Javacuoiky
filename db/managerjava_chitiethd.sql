...
CREATE TABLE `chitiethd` (
  `maHD` varchar(45) CHARACTER SET utf8 COLLATE utf8_unicode_ci NOT NULL,
  `maSP` varchar(45) CHARACTER SET utf8 COLLATE utf8_unicode_ci NOT NULL,
  `soluongCTHD` int NOT NULL,
  `dongiaCTHD` varchar(45) COLLATE utf8_unicode_ci NOT NULL,
  `thanhtienCTHD` varchar(45) COLLATE utf8_unicode_ci NOT NULL,
  KEY `maHD_1_idx` (`maHD`),
  KEY `maSP_1_idx` (`maSP`),
  CONSTRAINT `maHD_1` FOREIGN KEY (`maHD`) REFERENCES `hoadon` (`maHD`),
  CONSTRAINT `maSP_1` FOREIGN KEY (`maSP`) REFERENCES `sanpham` (`maSP`)
